...
async def start(client, message):
    ...
    buttons = [
        [
            InlineKeyboardButton('Owner', url='https://t.me/jagtarsidhu'),
        ],
        [
...
async def show_help(client, message):
    ...
    if message.chat.type != "private" and message.from_user is None:
        k=await message.reply(
            text="tu admin nhi hai and kabi ban b ni payega",
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(f"admin se bheekh maango", url=f"https://t.me/jagtarsidhu"),
                    ]
                ]
            ),)
        await delete_messages([message, k])
...
async def repo_(client, message):
    buttons = [
        [
            InlineKeyboardButton('🧩 Repository', url='https://github.com/jagtarsidhu/VCPlayerBot'),
            InlineKeyboardButton('⚙️ jagtar sidhu', url='https://t.me/jagtarsidhu'),     
        ],
        [
            InlineKeyboardButton('🗑 Close', callback_data='close'),
        ]
    ]
    await message.reply("<b>bot is made with ❤️ by jagtar sidhu for exchangers adda group.</b>", reply_markup=InlineKeyboardMarkup(buttons), disable_web_page_preview=True)
    await delete_messages([message])
